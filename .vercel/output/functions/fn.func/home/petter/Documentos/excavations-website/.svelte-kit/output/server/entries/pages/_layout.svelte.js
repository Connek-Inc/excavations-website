...
const css = {
  code: "@keyframes svelte-1khgdps-slide-up{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}.animate-slide-up.svelte-1khgdps{animation:svelte-1khgdps-slide-up 0.4s ease-out}",
  map: null
};
const ConsentBanner = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $$unsubscribe_language;
  $$unsubscribe_language = subscribe(language, (value) => value);
  $$result.css.add(css);
  $$unsubscribe_language();
