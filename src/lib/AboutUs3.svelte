...
<div class="flex py-12 w-full justify-center items-center m-auto">
    <!-- <div class="text-black md:w-[70%] w-[90%] m-auto">
        hi
    </div> -->
    <div class='bg-black bg-opacity-30 md:w-[80%] w-[90%] text-white p-8'>
        <div class="flex flex-col items-center space-y-6">
            <div>
                <h1 class="h1">About Us</h1>
            </div>
            <div class="text-center">
                <p>Le Bon Vieux Temps</p>
                <p>2051B Rue St-Denis</p>
                <p>Quartier Latin</p>
                <p>(514) 987-8222</p>    
            </div>
